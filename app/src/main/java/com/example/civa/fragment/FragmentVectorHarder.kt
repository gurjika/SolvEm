...
class FragmentVectorHarder:Fragment(R.layout.fragment_vector_harder) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonMore = view.findViewById(R.id.buttonMoreVectorHarder)
        ...
        buttonCalculate.setOnClickListener {
            if(operation == "CROSS"){
               val resultArray = getCross(editTextsOne,editTextsTwo)
                ...
                resultStringOne = resultStringOne + "x" + ";" + dimension.toString() + ";To harder"
                ...
                resultStringOne = resultStringOne + "SIN" + ";" + dimension.toString() + ";To harder"
                resultStringTwo = "$resultStringTwo$dimension;To harder"



                val resultArray = getCross(editTextsOne,editTextsTwo)
                var denominator = (findMagnitude(editTextsOne) * findMagnitude(editTextsTwo)).toString()
                ...
                for(i in 0 until 3){
                    resultStringOne += editTextsOne[i]!!.text.toString().toDouble().toString() + ";"
                    resultStringTwo += editTextsTwo[i]!!.text.toString().toDouble().toString() + ";"
                    resultStringThree += editTextsThree[i]!!.text.toString() + ";"
                }
